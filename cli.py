...
class LatexOCR:
    ...
    def __init__(self, arguments=None):
        ...
        if arguments is None:
            arguments = Munch({'config': 'settings\config50.yaml', 'checkpoint': 'C:\GOME\pix2tex\pix2tex\checkpoints\50k_crawled\50k_crawled_e01_step5999.pth', 'no_cuda': True, 'no_resize': False})
        ...
        print("-"*50)
        self.args.checkpoint = 'C://GOME//pix2tex//pix2tex//checkpoints//50k_crawled//50k_crawled_e01_step5999.pth'
        print(self.args.checkpoint)
        print("-"*50)
        self.model.load_state_dict(torch.load('C://GOME//pix2tex//pix2tex//checkpoints//50k_crawled//50k_crawled_e01_step5999.pth', map_location=self.args.device))
        self.model.eval()

        print(os.path.join(os.path.dirname(self.args.checkpoint), 'image_resizer.pth'))
