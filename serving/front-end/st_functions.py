...
def load_css():
    with open("C://GOME//pix2tex//pix2tex//serving//front-end//style.css") as f:
        st.markdown('<style>{}</style>'.format(f.read()), unsafe_allow_html=True)
    st.markdown('<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">', unsafe_allow_html=True)

def st_button(url, label, title):
    # if icon == 'youtube':
    #     button_code = f'''
    #     <p>
    ...
    #     </p>'''
    # button_code = f'''
    #     <a class="refCard_Container__LoksC" href={url}>
    #         <h4>{title}</h4>
    #         <p>
    #         {label}
    #         </p>
    ...
    button_code = f'''
        <div class="hellogome">
            <a class="refCard_Container__LoksC resfCard_Third__Au4Xh" href={url}>
                <h4>{title}</h4>
                <p>
                {label}
                </p>
