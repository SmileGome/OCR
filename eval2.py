...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='model\settings\-.yaml', help='path to yaml config file', type=str)
    parser.add_argument('-c', '--checkpoint', default="C:\GOME\pix2tex\pix2tex\checkpoints\pix2tex_lukas_e30\pix2tex_lukas_e30_e02_step1058.pth", type=str, help='path to model checkpoint')
    parser.add_argument('-d', '--data', default='dataset\\data\\50K\\test50k.pkl', type=str, help='Path to Dataset pkl file')
